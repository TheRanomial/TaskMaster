...
import CreateContent from "../_components/Modals/CreateContent";
import UpdateContent from "../_components/Modals/UpdateContent";
...
export default function Page() {
  const { theme, incompleteTasks, openModal, modal, modalValue, setModalValue } =
    useGlobalState();
